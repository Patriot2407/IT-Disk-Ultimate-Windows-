...
$csv_file = "$dir\serverlist.csv"          #<---------------
$csv = Import-Csv $csv_file                #<----- imports the csv data.
foreach($item in $csv)
    {
    $servers = $servers + "$($item.servers)" + ','
    }
...
write-host "Servers that are down: $errorcount" -foregroundcolor “red”
write-host "--------------------------" -foregroundcolor “red”
Write-Host ""
write-host "--------------------------" -foregroundcolor “green”
Write-Host "Servers that are up: $goodcount" -foregroundcolor “green”
write-host "--------------------------" -foregroundcolor “green”
Write-Host ""
